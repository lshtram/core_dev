...
## Phase 2.5: UI Prototyping (Code-First)

**User Action**: Reviews interactive HTML mockups.
**Agent Action**:

- Creates `docs/prototypes/<feature>.html` using pure HTML and Tailwind CSS (CDN).
- **Constraint**: No React, no build steps. Just layout and flow verification.
- Validates responsiveness and user interaction states (hover, focus).

**GATE**: User approves the HTML prototype.
